...
git fetch https://review.openstack.org/openstack/nova refs/changes/67/232367/4 && git cherry-pick FETCH_HEAD || echo "Could be that patch/set changed or it was merged into master!"
popd
set -e
